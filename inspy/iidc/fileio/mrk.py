...
def write_detection_set(filename, per_ch_events, ch_labels, id=42):
    mrks = [(ch_labels[i], id, chevj) for i, chev in enumerate(ch_events) for chevj in chev]
    mrk.write_mrk(filename, mrks)
