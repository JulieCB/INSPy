...
class CloudPicker(pg.PlotWidget):
    ...
    def __init__(self, xy, labels=None, parent=None):
...
class CloudStats(pg.PlotWidget):
    ...
    - Holds a 3D array of epoch data
    ...
    def __init__(self, ep, labels, parent=None):
...
class ClassAtlas(qg.QMainWindow):
    ...
    def __init__(self, events, ep, xy, labels, ch_labels, parent=None):
        ...
        self.split_ctrl.addWidget(self.b_add_class)
    ...
    def add_class(self):
        ...
        picker = CloudPicker(self.xy, self.labels)
        self.lay_pickers.addWidget(picker)

        # setup stats and dock
        stats = CloudStats(self.ep, self.ch_labels)
